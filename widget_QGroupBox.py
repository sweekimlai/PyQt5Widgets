...
class MainUI(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        gridLayout.setContentsMargins(4, 4, 4, 4)  # left, top, right, bottom
        ...
        # ------------ QGroupBox ------------------------------
        grpBox = QtWidgets.QGroupBox('Group Box')
        grpBox.setCheckable(True)
        grpBox.setLayout(gridLayout)
        ...
        self.setWindowTitle("QGroupBox Sample")
